...
resource "azurerm_storage_account" "sa_orbital" {
  ...
  network_rules {
    default_action             = "Deny"
    ip_rules                   = ["13.0.0.0/8", "20.0.0.0/8", "23.0.0.0/8", "40.0.0.0/8", "52.0.0.0/8", "65.0.0.0/8", "104.0.0.0/8", "131.0.0.0/8", "134.0.0.0/8", "137.0.0.0/8", "138.0.0.0/8", "157.0.0.0/8", "168.0.0.0/8", "191.0.0.0/8", "193.0.0.0/8", "199.0.0.0/8", "204.0.0.0/8", "207.0.0.0/8", "208.0.0.0/8", "209.0.0.0/8"]
